...
c GNU General Public License for more details.
      ...
      SUBROUTINE g09fopt(tau,ntau,natom,natomt,nshared,gmemo,
...
cc                  return
 ...
 9000 continue
      write (6,*) 'ERROR: Complete convergence failure V set to 1.0d20'
c      stop
      vtot = 1.0d20
      irepeat=irepeat+1
      write(6,*)'ires = ', ires
